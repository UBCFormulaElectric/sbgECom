...
SbgErrorCode sbgEComCmdOutputGetConf(
    ...
    SbgEComOutputMode *pConf)
{
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        errorCode = sbgEComProtocolSend(
            &pHandle->protocolHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_OUTPUT_CONF,
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            errorCode = sbgEComReceiveCmd2(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_OUTPUT_CONF, &receivedPayload,
...
SbgErrorCode sbgEComCmdOutputSetConf(
    SbgEComHandle *   pHandle,
    SbgEComOutputPort outputPort,
    SbgEComClass      classId,
    SbgEComMsgId      msgId,
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            errorCode = sbgEComWaitForAck(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_OUTPUT_CONF, pHandle->cmdDefaultTimeOut);
...
SbgErrorCode sbgEComCmdOutputClassGetEnable(
    SbgEComHandle *   pHandle,
    SbgEComOutputPort outputPort,
    SbgEComClass      classId,
    bool *            pEnable)
{
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        //
        errorCode = sbgEComProtocolSend(
            &pHandle->protocolHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_OUTPUT_CLASS_ENABLE,
            sbgStreamBufferGetLinkedBuffer(&outputStream), sbgStreamBufferGetLength(&outputStream));
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            //
            errorCode = sbgEComReceiveCmd2(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_OUTPUT_CLASS_ENABLE, &receivedPayload,
                pHandle->cmdDefaultTimeOut);
...
SbgErrorCode sbgEComCmdOutputClassSetEnable(
    SbgEComHandle *   pHandle,
    SbgEComOutputPort outputPort,
    SbgEComClass      classId,
    bool              enable)
{
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            //
            errorCode = sbgEComWaitForAck(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_OUTPUT_CLASS_ENABLE, pHandle->cmdDefaultTimeOut);
...
SbgErrorCode sbgEComCmdCanOutputGetConf(
    SbgEComHandle *    pHandle,
    ...
    bool *             pExtended)
{
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        //
        errorCode = sbgEComProtocolSend(
            &pHandle->protocolHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_CAN_OUTPUT_CONF,
            sbgStreamBufferGetLinkedBuffer(&outputStream), sbgStreamBufferGetLength(&outputStream));
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            //
            errorCode = sbgEComReceiveCmd2(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_CAN_OUTPUT_CONF, &receivedPayload,
                pHandle->cmdDefaultTimeOut);
...
SbgErrorCode sbgEComCmdCanOutputSetConf(
    SbgEComHandle *   pHandle,
    SbgECanMessageId  internalId,
    ...
    bool              extended)
{
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            //
            errorCode = sbgEComWaitForAck(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_CAN_OUTPUT_CONF, pHandle->cmdDefaultTimeOut);
...
SbgErrorCode sbgEComCmdOutputGetNmeaTalkerId(SbgEComHandle *pHandle, SbgEComOutputPort outputPort, char *pNmeaTalkerId)
{
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        //
        errorCode = sbgEComProtocolSend(
            &pHandle->protocolHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_NMEA_TALKER_ID,
            sbgStreamBufferGetLinkedBuffer(&outputStream), sbgStreamBufferGetLength(&outputStream));
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            //
            errorCode = sbgEComReceiveCmd2(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_NMEA_TALKER_ID, &receivedPayload,
                pHandle->cmdDefaultTimeOut);
...
SbgErrorCode
    sbgEComCmdOutputSetNmeaTalkerId(SbgEComHandle *pHandle, SbgEComOutputPort outputPort, const char *pNmeaTalkerId)
{
    SbgErrorCode    errorCode = SBG_NO_ERROR;
    uint32_t        trial;
    uint8_t         outputBuffer[3];
    ...
    for (trial = 0; trial < pHandle->numTrials; trial++)
    {
        ...
        if (errorCode == SBG_NO_ERROR)
        {
            ...
            //
            errorCode = sbgEComWaitForAck(
                pHandle, SBG_ECOM_CLASS_LOG_CMD_0, SBG_ECOM_CMD_NMEA_TALKER_ID, pHandle->cmdDefaultTimeOut);
