...
{
    static const SbgEComSignalIdDesc signalIdDesc[] = { { SBG_ECOM_SIGNAL_ID_UNKNOWN, "unknown" },
...
const char *sbgEComConstellationToStr(SbgEComConstellationId constellationId)
{
    static const char *enumToStrLut[] = {
        [SBG_ECOM_CONSTELLATION_ID_UNKNOWN] = "unknown", [SBG_ECOM_CONSTELLATION_ID_GPS] = "gps",
        [SBG_ECOM_CONSTELLATION_ID_GLONASS] = "glonass", [SBG_ECOM_CONSTELLATION_ID_GALILEO] = "galileo",
        [SBG_ECOM_CONSTELLATION_ID_BEIDOU] = "beidou",   [SBG_ECOM_CONSTELLATION_ID_QZSS] = "qzss",
        [SBG_ECOM_CONSTELLATION_ID_SBAS] = "sbas",       [SBG_ECOM_CONSTELLATION_ID_IRNSS] = "irnss",
